...
void EmptyLinkFunctionForGeneratedCodeFileUploaderPlugin_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_FileUploaderPlugin()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_FileUploaderPlugin_OnFileUploadResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_FileUploaderPlugin_OnParsedServerResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_FileUploaderPlugin_OnFileUploadProgress__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/FileUploaderPlugin",
				SingletonFuncArray,
